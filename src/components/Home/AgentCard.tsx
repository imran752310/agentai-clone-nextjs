...
export default function AgentCard() {
  return (
    <div className="my-20">
      ...
      <div className="lg:w-[70%] md:w-[80%] w-[100%] mx-auto grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 p-10 bg-white">
